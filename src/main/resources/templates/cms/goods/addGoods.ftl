                                        ...
                                        <table class="table_new">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input id="account_input"  class="form-control" name="account" style="display:inline-block;" /><label id="account_input_info" style="display:inline-block;">* 商品名称</label></td>
                                                </tr>
                                                <tr>
                                                    <th width="20%" style="text-align:right;">分类:</th>
                                                    <td><input id="nick_name_input"  class="form-control" name="nickName" style="display:inline-block;"/><label id="nick_name_input_info" style="display:inline-block;">* 分类</label></td>
                                                </tr>
                                                <tr>
                                                    <th width="20%" style="text-align:right;">品牌:</th>
                                                    <td><input id="password_input"  class="form-control" name="password" style="display:inline-block;"/><label id="password_input_info" style="display:inline-block;">* 品牌</label></td>
                                                </tr>
